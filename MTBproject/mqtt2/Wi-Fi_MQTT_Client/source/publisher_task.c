...
//                	printf("data %d\n", publisher_q_data.data);
                	...
                	char string_packed_coordinate[20];
                	sprintf(string_packed_coordinate, "%d", publisher_q_data.data);
                	char *pointer_to_string = string_packed_coordinate;
                	publish_info.payload = pointer_to_string;
