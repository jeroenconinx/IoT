...
int main()
{
    ...
    xTaskCreate(control_task, "Control Task", MQTT_CLIENT_TASK_STACK_SIZE, NULL, 2, NULL);
    xTaskCreate(servo_task, "Drive Servo Task", MQTT_CLIENT_TASK_STACK_SIZE, NULL, 2, NULL);
